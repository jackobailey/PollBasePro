---
title: |
  | PollBasePro: Daily Estimates of Aggregate Voting Intention in Britain from `r format(min(britpol::pollbasepro$date), "%Y")` to the Present Day\thanks{This article benefitted from much useful feedback. We owe particular thanks to Chris Hanretty, who inspired this project and provided much useful feedback. We would also like to thank Hannah Willis, Y, and Z for offering their time to review our manuscript. Finally, we would like to extend a special thanks to all of the volunteers who work to maintain such a comprehensive list of British opinion polling data on Wikipedia.}
author: |
