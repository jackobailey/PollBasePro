...
Your may use the `britpol` codebase for your own purposes, but you must do so *with attribution*. That is, you may reproduce, reuse, and change the code here as you see fit, but must state in each case that you used britpol to produce your work. The citations for each item in `britpol` are as follows:
