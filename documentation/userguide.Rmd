---
title: |
  | PollBasePro v`r packageVersion("PollBasePro")` (Beta)
...
- ``r paste0("pollbase_", packageVersion("PollBasePro"), ".dta")``
- ``r paste0("pollbasepro_", packageVersion("PollBasePro"), ".dta")``
- ``r paste0("pollbase_", packageVersion("PollBasePro"), ".sav")``
- ``r paste0("pollbasepro_", packageVersion("PollBasePro"), ".sav")``
...
\delta_{j} &\sim \mathrm{Normal}(0, 0.1) \text{ for } j \text{ in } 1, ..., J \srlab{Prior on house effects, $\delta$} \\
